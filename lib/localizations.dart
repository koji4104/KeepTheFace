...
class Localized {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'in_save_mb': 'In-App max capacity',
      'in_save_mb_desc':
          'Old data will be deleted when in-app data exceeds the max capacity or max number. Please move the data you want to keep.',
      ...
      'saver_mode_desc': 'Black will turn into a black screen after 6 seconds, and tap to cancel.',
    ...
    'ja': {
      ...
      'in_save_mb': 'アプリ内データ上限容量',
      'in_save_mb_desc': 'アプリ内データが上限容量・上限数を超えると古いものから削除します。残したいデータは移動してください。',
      'in_save_num': 'アプリ内データ上限数',
      'in_save_num_desc': 'アプリ内データが上限容量・上限数を超えると古いものから削除します。残したいデータは移動してください。',
      'autostop_sec': '自動停止',
