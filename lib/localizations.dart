...
class Localized {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'saver_mode_desc': 'Black will turn into a black screen after 5 seconds, and tap to cancel.',
    ...
    'ja': {
      ...
      'save_num': 'アプリ内データ保存数',
      'save_num_desc': 'アプリ内データが保存数を超えると古いものから削除されます。残したいデータはアプリ内データからコピーしてください。本体の空き容量が5GB以下のとき保存されません。',
      'autostop_sec': '自動停止',
      ...
      'saver_mode_desc': 'Black は5秒後に黒画面になります。タップすると解除できます。',
